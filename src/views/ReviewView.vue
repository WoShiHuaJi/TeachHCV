...
<template>
  <div class="page">
    ...
    <div v-if="upcoming.length" class="card" style="padding: 4px 16px">
      <div v-for="u in upcoming" :key="u.lesson.id" class="row-item">
        <span>{{ u.lesson.title }}</span>
    ...
    <div v-if="mastered.length" class="card" style="padding: 4px 16px">
      <div v-for="l in mastered" :key="l.id" class="row-item">
        <span>{{ l.title }}</span>
